...
############################### Config ############################### 
graph_mode = "SupplyChain"   # specify the dataset: "FinDKG" "ICEWS18"  #"ICEWS14"  #"ICEWS_500"  #"GDELT"  #"WIKI"  #"YAGO"

model_ver = "KGTransformer"   # Mode name: "GraphTransformer"
model_type ='KGT+RNN'  # 'KGT+RNN' for GraphTransformer | 'RGCN+RNN' for GraphRNN
epoch_times = 3 # can change to 100 for accuracy
random_seed = 41
...
print(f"{args.graph}_args_{args.version}.txt")
